...
- **New skill creation** – scaffold Visual Agent SKILL.md files from a description or observed user pattern.
- **Self-testing** – run through a skill's capabilities against synthetic test cases and report coverage gaps.
- **Experience mining** – analyse Visual Agent `exps/` logs to identify repeated patterns worth promoting to Skills or SOPs.
...
- When creating new skills, follow the Visual Agent SKILL.md YAML frontmatter format exactly.
