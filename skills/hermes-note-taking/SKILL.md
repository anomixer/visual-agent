...
- **Chalkboard integration** – push structured note summaries to the AIPC Agent Chalkboard for visual review.
...
- Keep AIPC Agent experience logs (`exps/`) separate from personal notes — do not cross-contaminate.
